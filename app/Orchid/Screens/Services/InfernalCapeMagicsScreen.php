...
class InfernalCapeMagicsScreen extends Screen
{
    public $option;
    ...
    {
        return $this->option?->name . ' Magics';
    }
    ...
    public function delete(ServiceOption $magic)
    {
        ...
        Toast::success('Magic deleted successfully');
    }
    ...
    public function create(ServiceOption $option)
    {
        ...
        Toast::success('The Magic created successfully');
    }
    ...
    public function edit(ServiceOption $magic)
    {
        ...
        Toast::success('The Magic updated successfully');
    }
}
