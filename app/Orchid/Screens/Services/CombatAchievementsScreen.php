...
class CombatAchievementsScreen extends Screen
{
    /**
    ...
    {
        return [
            'options' => ServiceOption::where('service', 'combat-achievements')->whereNull('parent_id')->get(),
        ];
    }
    ...
    {
        return 'Combat Achievements | Difficulties';
    }
            ...
            Layout::table('options', [
                ...
                TD::make('actions')
                    ...
                    ->render(function (ServiceOption $option) {
                        return Group::make([
                            Link::make('Monsters / Games')
                                ->route('platform.services.combat-achievements.monsters', $option->id)
                                ->icon('dollar'),
