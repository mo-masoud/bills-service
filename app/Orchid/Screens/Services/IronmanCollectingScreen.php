...
class IronmanCollectingScreen extends Screen
{
    ...
    {
        return [
            'options' => ServiceOption::where('service', 'ironman-collecting')->whereNull('parent_id')->get(),
        ];
    }
    ...
    {
        return 'Ironman Collecting | Types';
    }
            ...
            Layout::table('options', [
                ...
                TD::make('actions')
                    ...
                    ->render(function (ServiceOption $option) {
                        return Group::make([
                            Link::make('Resources')
                                ->route('platform.services.ironman-collecting.resources', $option->id)
                                ->icon('dollar'),
